...
2. Add a harness observer boundary:
...
3. Implement `codex_exec_json` observer:
...
4. Revalidate Claude interactive credentials:
...
5. Implement `claude_hooks` observer only after credential health is proven:
