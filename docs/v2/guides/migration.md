...
├── pyproject.toml
├── README.md
└── firecrawl-scraper.tool.yaml  # Provider-specific
```
...
├── pyproject.toml
├── README.md
└── tool.yaml  # Standard spec
```

**Changes**:
1. Rename `firecrawl_scraper.py` → `impl.py`
...
- ✅ Keep: Headings, lists, code blocks, examples
- ❌ Remove: Level indicators, purpose statements
...
for cmd in primitives/v1/commands/*/*/; do
  ...
  echo "✓ Created primitives/v2/commands/$category/$name.md"
done
```
