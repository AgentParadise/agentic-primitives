...
| **notifications** | `claude plugin install notifications@agentic-primitives --scope user` | Push notifications (ntfy, macOS, Pushover). After install, run `/notifications:configure` to set up. |
...
| **notifications** | `configure` | -- | -- | Notification, Stop, TaskCompleted → ntfy/macOS/Pushover with sound themes |
