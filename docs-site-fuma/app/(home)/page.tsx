        ...
        <div className="container mx-auto px-6 py-16 md:py-24">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-lg md:text-xl text-fd-muted-foreground max-w-2xl mb-8">
              Atomic building blocks for AI coding systems. Build, version, and deploy
              reusable components across Claude, OpenAI, and more.
            </p>
        ...
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <QuickLink
              ...
              title="Quick Start"
              description="Create your first primitive in 5 minutes"
            />
            <QuickLink
              href="/docs/cli"
