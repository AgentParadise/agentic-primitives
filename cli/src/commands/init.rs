...
pub fn init(path: &Path) -> Result<()> {
    println!("🚀 Initializing agentic-primitives repository at {path:?}\n");
...
fn print_success_message(path: &Path) -> Result<()> {
    ...
    println!(
        "{}",
        "✨ Successfully initialized repository!".green().bold()
    );
    println!();
    println!("📁 {}", "Created directory structure:".bold());
    println!("  ├── specs/v1/ {} schemas", "(5".dimmed());
    println!("  ├── primitives/v1/ {} subdirectories", "(6".dimmed());
    println!("  ├── primitives/experimental/");
    println!("  ├── providers/");
    println!("  └── docs/adrs/");
    println!();
    println!("📄 {}", "Generated files:".bold());
    println!("  ├── primitives.config.yaml");
    println!("  ├── README.md");
    println!("  └── .gitignore");
    println!();
